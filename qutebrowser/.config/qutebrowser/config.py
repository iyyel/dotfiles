...
## Type: String
c.content.headers.accept_language = 'en-US,us,uk,en-UK,da-DK,en-DK,dk'
...
## Type: Font
c.fonts.hints = 'bold 10pt Fira Sans'

## Font used in the keyhint widget.
## Type: Font
c.fonts.keyhint = '10pt Fira Sans'
...
## Type: Font
c.fonts.monospace = '"Fira Sans", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = '/home/iyyel/.dotfiles/startpage/index.html'
